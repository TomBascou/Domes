                    ...
                    <div class="bottom--domes-right">
                        <div id="wrap">
                            <form action="" autocomplete="on">
                                ...
                                <input id="search_submit" value="Rechercher" type="submit" class="search-submit " style="background-image: url('${pageContext.servletContext.contextPath}/asset/images/multi-page/loupe.png');">
                            </form>
                        </div>
